...
def make_allplanets_df_vec_extrap_kepler(df, starid_zp):
    totalRows = df.loc[:, "Nplanets"].sum()
...
def Bryson_select(nselect=1):
    balls = np.array([])

    fn_occ = "../data/bryson/occurrenceGrid_bryson.npy"
    fn_p = "../data/bryson/occurrencePeriod.npy"
    fn_r = "../data/bryson/occurrenceRadius.npy"
